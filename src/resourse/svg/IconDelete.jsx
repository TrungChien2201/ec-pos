const IconDelete = (props) => (
  <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 16 16' fill='none'>
    <path d='M13.5 3.5H2.5' stroke='#000000C9' strokeLinecap='round' strokeLinejoin='round' />
    <path d='M6.5 6.5V10.5' stroke='#000000C9' strokeLinecap='round' strokeLinejoin='round' />
    <path d='M9.5 6.5V10.5' stroke='#000000C9' strokeLinecap='round' strokeLinejoin='round' />
    <path
